...
export default function SizeSm(){
        ...
        <div className="w-full px-6 py-11">
            <div className="flex flex-col">
                ...
                <div className="flex py-8 gap-5">
                    ...
                    {/* CV */}
                    <a href="/files/CV Muhammad Rafi Satria.pdf" download="CV_Rafi_Programmer.pdf" className="" target="blank">
                        <svg className="fill-current text-slate-300 hover:text-cyan-300 mr-5" role="img" width={25} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="mt-15">
                    ...
                    <div>                       
                        ...
                        <div className="w-full pt-10">
                            <div className="flex flex-col">
                                <div className="">
                                    <p className="text-xs text-slate-400 font-normal pb-2">DES 2025 - MEI 2026</p>
                                </div>
                                <div className="">
                                    <a href="" className="group" target="blank">
                                        <p className="text-white group-hover:text-cyan-300 mb-3 font-bold">
    ...
    <div>
        <p className="text-sm font-bold text-slate-50 tracking-wider">
            PROJECTS
        </p>
    </div>
    ...
    <div className="pt-10 pb-5">
        <div className="flex flex-col">
            ...
            <div>
                <Image src="/images/Skycast.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
            </div>
        </div>
    </div>
    ...
    <div className="pt-10 pb-5">
        <div className="flex flex-col">
            ...
            <div>
                <Image src="/images/SIAKAD.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
            </div>
        </div>
    </div>
    ...
    <div className="pt-10 pb-5">
        <div className="flex flex-col">
            ...
            <div>
                <Image src="/images/Dermaone.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
            </div>
        </div>
    </div>
    ...
    >
        ...
        <div className="pt-10 pb-5">
            <div className="flex flex-col">
                ...
                <div>
                    <Image src="/images/SIDAK.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
                </div>
            </div>
        </div>
        ...
        <div className="pt-10 pb-5">
            <div className="flex flex-col">
                <div>
                    <a href="https://app.ibnukosasih.com/app/automation-registration/registrasi-692d1a0d6cf21868cf1bf0c6" target="blank" className="group">
                        <p className="text-white group-hover:text-cyan-300 mb-3 font-bold">
                ...
                <div>
                    <Image src="/images/Reservasi.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
                </div>
            </div>
        </div>
        ...
        <div className="pt-10 pb-5">
            <div className="flex flex-col">
                ...
                <div>
                    <Image src="/images/Absensi.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
                </div>
            </div>
        </div>
        ...
        <div className="pt-10 pb-5">
            <div className="flex flex-col">
                <div>
                    <a href="https://app.ibnukosasih.com/app/kalkulator-komisi-21ee/verifikasi" target="blank" className="group">
                        <p className="text-white group-hover:text-cyan-300 mb-3 font-bold">
                ...
                <div>
                    <Image src="/images/Dashboard Loyal.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
                </div>
            </div>
        </div>
        ...
        <div className="pt-10 pb-5">
            <div className="flex flex-col">
                ...
                <div>
                    <Image src="/images/Kalkulator.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
                </div>
            </div>
        </div>
        ...
        <div className="pt-10 pb-5">
            <div className="flex flex-col">
                ...
                <div>
                    <Image src="/images/SatuSehat.png" alt="Profil" width={200} height={200} className="mt-5 border border-slate-800 border-2 rounded-md"/>
                </div>
            </div>
        </div>
