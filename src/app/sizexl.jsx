...
export default function SizeXl(){
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
            ...
            },{ threshold: 0.2 } // muncul setengah layar baru dianggap aktif
        );
    ...
    return (
        ...
        <div className="w-7/10 mx-auto pt-25 max-xl:w-full">
            <div className="flex px-17">

                {/* Left */}
                <div className="w-4/10 flex h-[900px] flex-col justify-between sticky top-25">

                    <div className="flex flex-col">

                        {/* Header */}
                        <div>
                            <h1 className="text-5xl font-bold text-slate-50">Muhammad Rafi Satria</h1>
                            <p className="text-cyan-300 py-3 font-medium text-xl">FullStack Web Engineer</p>
                            <p className="text-slate-400 font-normal pt-2">I build scalable, efficient, and secure full-stack web applications from frontend to backend.</p>
                        </div>
                        {/* Header */}
                        ...
                        <div className="mt-20 flex flex-col gap-6">
                            {navItems.map((item) => (
                                <div key={item.id}  onClick={() => scrollTo(item.id)} className={`group flex items-center cursor-pointer w-45 transition-colors duration-200 ${active === item.id ? "text-cyan-300" : "text-slate-400 hover:text-cyan-300"}`}>
                                    <div className={`mr-4 transition-all duration-200 ease-in-out ${active === item.id ? "w-20" : "w-12 group-hover:w-20"}`}>
                                        <hr className={`border-t-2 transition-colors duration-200 ${active === item.id ? "border-cyan-300" : "border-slate-300 group-hover:border-cyan-300"}`}/>
                                    </div>
                                    <div>
                    ...
                    <div className="flex mb-24">
                        ...
                        <a href="https://www.linkedin.com/in/muhammad-rafi-satria-a1160b252/" className="" target="blank">
                            <svg className="fill-current text-slate-300 hover:text-cyan-300 mr-5" role="img" width={25} viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* CV */}
                        <a href="/files/CV Muhammad Rafi Satria.pdf" download="CV_Muhammad_Rafi_Satria.pdf" className="" target="blank">
                            <svg className="fill-current text-slate-300 hover:text-cyan-300 mr-5" role="img" width={25} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Right */}
                <div className="w-6/10 overflow-y-auto relative mb-20">
                    ...
                    {/* Stacks */}
                    <section id="stacks" className="ml-25 mr-10 pl-5 pt-5 mt-20 hover:bg-slate-600/20 hover:backdrop-blur-md hover:shadow-xl transition-all duration-300 rounded-xl">
                        <div>
                            <h1 className="font-semibold text-md text-cyan-300 text-center mr-8">STACKS</h1>
                        </div>
                    ...
                    <section id="experience" className="grid mt-15">
                        ...
                        <a href="https://drive.google.com/drive/folders/1uRcyfkHF5zhMjr-T1TeheAF2xmJ_DvbQ?usp=sharing" target="blank">
                            <div className="ml-17 pr-8 pl-8 pt-5 pb-5 hover:bg-slate-600/20 hover:backdrop-blur-md hover:shadow-xl transition-all duration-300 rounded-xl group">
                                <div className="flex">
                                    <div className="w-1/3">
                                        <p className="text-xs text-slate-400 font-normal">FEB - JUNI 2024</p>
                                    </div>
                                    <div className="w-2/3">
                    ...
                    {/* Footer */}
                    <div className="w-3/4 mt-30 mb-20 pl-25">
